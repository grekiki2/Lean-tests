...
Opomba: Iz definicije vidimo, da se bomo ukvarjali z enostavnimi končnimi neusmerjenimi grafi, ker je cilj preverjati lastnosti za konkretne grafe ki jih
...
Pri naslednjih dveh dokazih bomo določene podrobnosti prepustili bralcu.
\begin{lema}
...
s čimer se ne bomo ukvarjali, ker je tema te diplomske naloge teorija grafov. Lean 4 smo uporabljali tudi
...
Za $2$-obarvljivost pa hiter algoritem obstaja in ga bomo tudi implementirali v Leanu ter dokazali njegovo pravilnost. 
...
Na podoben način smo preizkusili tudi hitrejši algoritem za preverjanje $2$-obarvljivosti.
\begin{figure}[H]
\begin{center}
...
Za primerjavo različnih podatkovnih struktur smo enak algoritem pognali tudi na leanovem tipu \lstinline{List} ki pa je osnovan
